...
/**
 * This is the item provider adapter for a {@link eCommercePMM.Discount} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiscountItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDiscountIDPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Discount ID feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDiscountIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Discount_discountID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Discount_discountID_feature", "_UI_Discount_type"),
				 ECommercePMMPackage.Literals.DISCOUNT__DISCOUNT_ID,
				 true,
				 false,
				 false,
	...
	protected void addAmountPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Discount_amount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Discount_amount_feature", "_UI_Discount_type"),
				 ECommercePMMPackage.Literals.DISCOUNT__AMOUNT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Discount)object).getDiscountID();
