...
/**
 * This is the item provider adapter for a {@link eCommercePMM.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider extends ItemItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_duration_feature", "_UI_Service_type"),
				 ECommercePMMPackage.Literals.SERVICE__DURATION,
				 true,
				 false,
				 false,
