...
/**
 * This is the item provider adapter for a {@link shapes.Triangle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TriangleItemProvider extends ShapeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triangle_a_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triangle_a_feature", "_UI_Triangle_type"),
				 ShapesPackage.Literals.TRIANGLE__A,
				 true,
				 false,
				 false,
	...
	protected void addBPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triangle_b_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triangle_b_feature", "_UI_Triangle_type"),
				 ShapesPackage.Literals.TRIANGLE__B,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addCPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Triangle_c_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Triangle_c_feature", "_UI_Triangle_type"),
				 ShapesPackage.Literals.TRIANGLE__C,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Triangle)object).getName();
