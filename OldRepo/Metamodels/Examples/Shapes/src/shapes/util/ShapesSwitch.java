...
public class ShapesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ShapesPackage.SHAPE_CONSTRUCTOR: {
				ShapeConstructor shapeConstructor = (ShapeConstructor)theEObject;
				T result = caseShapeConstructor(shapeConstructor);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Shape Constructor</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Shape Constructor</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseShapeConstructor(ShapeConstructor object) {
		return null;
	}
