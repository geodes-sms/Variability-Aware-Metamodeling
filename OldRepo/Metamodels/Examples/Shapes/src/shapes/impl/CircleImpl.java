 ...
 * </p>
 * <ul>
 *   <li>{@link shapes.impl.CircleImpl#getRadius <em>Radius</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CircleImpl extends ShapeImpl implements Circle {
	...
	protected EClass eStaticClass() {
		return ShapesPackage.Literals.CIRCLE;
	}
	...
	public void setRadius(int newRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ShapesPackage.CIRCLE__RADIUS, oldRadius, radius));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ShapesPackage.CIRCLE__RADIUS:
				return getRadius();
		}
