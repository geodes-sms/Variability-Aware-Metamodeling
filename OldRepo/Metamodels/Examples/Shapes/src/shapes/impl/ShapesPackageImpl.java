...
public class ShapesPackageImpl extends EPackageImpl implements ShapesPackage {
	 ...
	 * @generated
	 */
	private EClass shapeConstructorEClass = null;
	 ...
	 * @see shapes.ShapesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ShapesPackage init() {
		...
		Object registeredShapesPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		ShapesPackageImpl theShapesPackage = registeredShapesPackage instanceof ShapesPackageImpl ? (ShapesPackageImpl)registeredShapesPackage : new ShapesPackageImpl();
	 ...
	 */
	@Override
	public EClass getShapeConstructor() {
		return shapeConstructorEClass;
	}
	 ...
	 */
	@Override
	public EReference getShapeConstructor_Shape() {
		return (EReference)shapeConstructorEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EAttribute getShapeConstructor_Name() {
		return (EAttribute)shapeConstructorEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EAttribute getRectangle_Length() {
	 ...
	 */
	@Override
	public EAttribute getTriangle_A() {
	 ...
	 */
	@Override
	public EAttribute getTriangle_B() {
	 ...
	 */
	@Override
	public EAttribute getTriangle_C() {
		return (EAttribute)triangleEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		shapeConstructorEClass = createEClass(SHAPE_CONSTRUCTOR);
		createEReference(shapeConstructorEClass, SHAPE_CONSTRUCTOR__SHAPE);
		createEAttribute(shapeConstructorEClass, SHAPE_CONSTRUCTOR__NAME);
		...
		createEAttribute(rectangleEClass, RECTANGLE__LENGTH);
		createEAttribute(rectangleEClass, RECTANGLE__WIDTH);

		triangleEClass = createEClass(TRIANGLE);
		createEAttribute(triangleEClass, TRIANGLE__A);
		createEAttribute(triangleEClass, TRIANGLE__B);
		createEAttribute(triangleEClass, TRIANGLE__C);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(shapeConstructorEClass, ShapeConstructor.class, "ShapeConstructor", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getShapeConstructor_Shape(), this.getShape(), null, "shape", null, 0, -1, ShapeConstructor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getShapeConstructor_Name(), ecorePackage.getEString(), "name", null, 0, 1, ShapeConstructor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRectangle_Length(), ecorePackage.getEInt(), "length", null, 0, 1, Rectangle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTriangle_A(), ecorePackage.getEInt(), "a", null, 0, 1, Triangle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTriangle_B(), ecorePackage.getEInt(), "b", null, 0, 1, Triangle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTriangle_C(), ecorePackage.getEInt(), "c", null, 0, 1, Triangle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
