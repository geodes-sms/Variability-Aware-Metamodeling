...
/**
 * This is the item provider adapter for a {@link vcsFeaturesMM.Database} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Database_connectionString_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Database_connectionString_feature", "_UI_Database_type"),
				 VcsFeaturesMMPackage.Literals.DATABASE__CONNECTION_STRING,
				 true,
				 false,
				 false,
	...
	protected void addDatabaseTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Database_DatabaseType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Database_DatabaseType_feature", "_UI_Database_type"),
				 VcsFeaturesMMPackage.Literals.DATABASE__DATABASE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 VcsFeaturesMMPackage.Literals.DATABASE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
