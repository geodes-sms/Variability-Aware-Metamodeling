...
public class CheckoutHandlerGenerator implements HandlerGenerator {
  @Override
  public CharSequence generate() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import commands.CheckoutCommand;");
    _builder.newLine();
    _builder.append("import controllers.PorcelainController;");
    _builder.newLine();
    _builder.append("import dialogs.CheckoutDialog;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class CheckoutHandler extends AbstractHandler {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("CheckoutCommand checkoutCommand;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private CheckoutDialog dialog;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public CheckoutHandler() {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("dialog = new CheckoutDialog(window.getShell(), PorcelainController.getInstance().getBranchesClean());");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("checkoutCommand = new CheckoutCommand(PorcelainController.getInstance().getWorkspace(), dialog.getBranchSelection());");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("checkoutCommand.call();");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
