...
public class RemoteAddHandlerGenerator implements HandlerGenerator {
  @Override
  public CharSequence generate() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import commands.RemoteAddCommand;");
    _builder.newLine();
    _builder.append("import dialogs.RemoteAddDialog;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class RemoteAddHandler extends AbstractHandler {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("RemoteAddCommand remoteAddCommand;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private RemoteAddDialog dialog;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("RemoteAddDialog dialog = new RemoteAddDialog(window.getShell());");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("remoteAddCommand = new RemoteAddCommand(dialog.getRemoteURL(), dialog.getRemoteName());");
    _builder.newLine();
    _builder.append("\t\t\t");
