...
public class PushCommandGenerator implements CommandGenerator {
  @Override
  public CharSequence generate() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class PushCommand implements ICommand {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public PushCommand(String username, String password) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("PorcelainController.getInstance().pushCommand(username, password);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
